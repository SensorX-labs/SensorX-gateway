...
public record UserInfoResponse(Guid Id, string Email, List<string> Roles, string? FullName = null, string? AvatarUrl = null);
...
public record UserResponse(Guid Id, string Email, string FullName, string? AvatarUrl, string Role, bool IsLocked, DateTimeOffset CreatedAt);
