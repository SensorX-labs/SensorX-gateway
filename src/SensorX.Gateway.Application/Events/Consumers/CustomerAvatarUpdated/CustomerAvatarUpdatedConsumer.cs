...
public class CustomerAvatarUpdatedConsumer(
    IAccountRepository _accountRepository,
    IUnitOfWork _unitOfWork
) : IConsumer<CustomerAvatarUpdatedEvent>
{
    public async Task Consume(ConsumeContext<CustomerAvatarUpdatedEvent> context)
    {
